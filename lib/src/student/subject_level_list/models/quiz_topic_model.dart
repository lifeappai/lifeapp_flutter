...
QuizTopicModel riddleTopicModelFromJson(String str) => QuizTopicModel.fromJson(json.decode(str));

String riddleTopicModelToJson(QuizTopicModel data) => json.encode(data.toJson());
