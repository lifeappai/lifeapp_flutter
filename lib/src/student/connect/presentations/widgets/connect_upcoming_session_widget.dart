...
class ConnectUpcomingSessionWidget extends StatelessWidget {
  final ConnectProvider provider;

  const ConnectUpcomingSessionWidget({required this.provider, super.key});

  @override
  Widget build(BuildContext context) {
    return provider.upcomingSessionModel != null
        ? SizedBox(
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) => Container(
                ...
                child: Column(
                  ...
                  children: [
                    // Image
                    provider.upcomingSessionModel!.data!.sessions!.data![index]
                                .user!.profileImage !=
                            null
                        ? ClipRRect(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  "${provider.upcomingSessionModel!.data!.sessions!.data![index].date!.day}-${provider.upcomingSessionModel!.data!.sessions!.data![index].date!.month}-${provider.upcomingSessionModel!.data!.sessions!.data![index].date!.year}",
                                  style: const TextStyle(
                          ...
                          const SizedBox(height: 7),
                          CustomButton(
                            name: provider.upcomingSessionModel!.data!.sessions!
                                        .data![index].isBooked
                                        .toString() ==
                                    "1"
                                ? StringHelper.booked
