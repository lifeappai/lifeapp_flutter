...
class MentorLoginService {
  ...
  Future sendOtp(String code) async {
    ...
    try {
      ...
      debugPrint("Mentor Login Code: ${response.statusCode}");

      return response;
    } on DioException catch (e) {
      debugPrint("Mentor Login Dio Error ${e.response}");
      Fluttertoast.showToast(msg: e.response!.data!["message"]);
      Loader.hide();
    } on SocketException catch(e) {
      Loader.hide();
      debugPrint("Mentor Login Socket Error: $e");
      Fluttertoast.showToast(msg: StringHelper.badInternet);
    } catch (e) {
      Loader.hide();
      debugPrint("Mentor Login Catch Error: $e");
