...
teacherStateBottomSheet({required BuildContext context, required TeacherSignUpProvider provider}) =>
    showModalBottomSheet(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, state) => Column(
          ...
          children: [
            Container(
              margin: const EdgeInsets.only(left: 100, right: 100, top: 15),
              height: 5,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: TextFormField(
                              ...
                              onChanged: (val) {
                                if(val.isNotEmpty) {
                                  provider.searchListOfLocation = List.from(provider.listOfLocation.where((element) => element.stateName!.toString().toLowerCase()
                      ...
                      if(provider.searchListOfLocation.isNotEmpty) MediaQuery.removePadding(
                        context: context,
                        removeTop: true,
                              ...
                              return Column(
                                children: [
                                  ListTile(
                                    ...
                                    title: Text(
                                      provider.searchListOfLocation[index].stateName!,
                                      style: const TextStyle(
                                        color: Colors.black54,
                                      ),
                                    ),
                                    onTap: () {
                                      provider.stateController.text = provider.searchListOfLocation[index].stateName!;
