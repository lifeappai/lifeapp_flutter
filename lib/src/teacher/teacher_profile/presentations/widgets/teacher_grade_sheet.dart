...
void teacherProfileGradeListBottomSheet(
    BuildContext context,
    TeacherProfileProvider provider,
    Map<String, dynamic> map,
    ) {
  // Track: bottom sheet opened
  MixpanelService.track("Profile Grade bottom sheet opened", properties: {
              ...
              children: provider.gradeList
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () {
                        // Track: grade selected
                        MixpanelService.track("Grade column in form updated", properties: {
                          "grade_id": e.toString(),
                          "timestamp": DateTime.now().toIso8601String(),
                        });
