...
class TeacherFaqDetailPage extends StatefulWidget {
  final TeacherFaqCategory category;

  const TeacherFaqDetailPage({
    super.key,
    required this.category,
  });

  @override
  State<TeacherFaqDetailPage> createState() => _TeacherFaqDetailPageState();
}

class _TeacherFaqDetailPageState extends State<TeacherFaqDetailPage> {
