...
//
//     final competenciesModel = competenciesModelFromJson(jsonString);

import 'dart:convert';

CompetenciesModel competenciesModelFromJson(String str) => CompetenciesModel.fromJson(json.decode(str));

String competenciesModelToJson(CompetenciesModel data) => json.encode(data.toJson());
...
class CompetenciesModel {
  ...
  factory CompetenciesModel.fromJson(Map<String, dynamic> json) => CompetenciesModel(
    status: json["status"],
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    laCompetenies: json["laCompetenies"] == null ? null : LaCompetenies.fromJson(json["laCompetenies"]),
  );

  Map<String, dynamic> toJson() => {
    "laCompetenies": laCompetenies?.toJson(),
  };
}
...
class LaCompetenies {
  ...
  factory LaCompetenies.fromJson(Map<String, dynamic> json) => LaCompetenies(
