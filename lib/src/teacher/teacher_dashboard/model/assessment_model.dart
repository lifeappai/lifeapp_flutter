...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    laAssessments: json["laAssessments"] == null ? null : LaAssessments.fromJson(json["laAssessments"]),
  );

  Map<String, dynamic> toJson() => {
    "laAssessments": laAssessments?.toJson(),
  };
}
...
class LaAssessments {
  ...
  factory LaAssessments.fromJson(Map<String, dynamic> json) => LaAssessments(
